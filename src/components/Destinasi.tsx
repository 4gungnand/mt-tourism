...
export default function Destinasi() {
    return (
        <div className="flex justify-center min-h-[900px] m-auto">
            <div className="flex flex-col items-center py-20 bg-teal-900 rounded-[95px] min-w-full">
                ...
                <div className="mt-24 text-6xl text-center text-white max-md:mt-10 max-md:max-w-full max-md:text-4xl font-serif">
